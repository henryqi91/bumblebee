...
class PlaneGame(pygame.sprite.Sprite,QObject):
    ...
    def plane_game_init(self,signal_center):
        ...
        self.background = pygame.image.load('plane/resources/image/hive_with_flower.png').convert()
        self.background = pygame.transform.scale(self.background,(860,860))
        # self.background.set_colorkey()
        self.game_over = pygame.image.load('plane/resources/image/gameover_large.png')
        self.game_over = pygame.transform.scale(self.game_over,(860,860))
        self.player_img = pygame.image.load('plane/resources/image/bee.png').convert_alpha()
        self.player_img = pygame.transform.scale(self.player_img, (100, 75))
        print(self.player_img.get_alpha())
        self.plane_img = pygame.image.load('plane/resources/image/shoot.png')
        self.obstacle_img = pygame.image.load('plane/resources/image/honey.png').convert_alpha()
        self.obstacle_img = pygame.transform.scale(self.obstacle_img,(30,30))
        # self.plane_img = pygame.transform.scale(self.plane_img,(1000,1000))

        pygame.display.set_caption('熊蜂吃蜜小游戏')
        ...
        self.player = Player(self.player_img, self.player_rect, self.player_pos,
            ...
            if not self.is_game_over:
                ...
                if self.is_running:
                    ...
                    # if not self.player.is_hit:
                        ...
                        #     self.shoot_frequency = 0
                    # 生成敌机，需要控制生成频率
                    if self.enemy_frequency % signal_center.freq == 0:
                        enemy1_pos = [random.randint(0, self.SCREEN_WIDTH - self.enemy1_rect.width), 100]
                        enemy_selection =  2 #random.randint(1,2) # 1-plane, 2-rock
